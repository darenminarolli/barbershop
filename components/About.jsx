...
const About = () => {
  const data={
    emri:['Ekperienc','Cmimet me te mira','Siguri','Stabilitet'],
    icon:['']
  }
  return (
    <section id='about' className='section_layout'>
      ...
      <div className='card_about  mt-6  rounded-md  text-black bg-slate-100'>
         ...
         <div className='card_container'>
           <h1 className='card_header'>Siguri</h1>
           <div className='small_card'>
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="icon">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
          </svg>
      ...
      <Image src='/assets/images/pexels-thgusstavo-santana-1813346.jpg' className='w-full rounded-md shadow-md mt-6 ' width={250} height={250} alt='photo'/>
